...
require (
	...
	github.com/gphotosuploader/google-photos-api-client-go v1.1.6 // indirect
	github.com/gphotosuploader/google-photos-api-client-go/v2 v2.4.2 // indirect
